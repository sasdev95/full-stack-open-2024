...
L.isValidElement = Ei;
L.lazy = function (e) {
    return { $$typeof: Df, _payload: { _status: -1, _result: e }, _init: Uf };
};
L.memo = function (e, t) {
 ...
 */ var Bf = xe,
    ...
    Wf =
        Bf.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
            ...
            return (
                ...
                O > K
                    ? ((C.sortIndex = O),
                      ...
                      n(s) === null &&
                          C === n(a) &&
                          (y ? (d(T), (T = -1)) : (y = !0), Hl(w, O - K)))
                    : ((C.sortIndex = Z), t(s, C), v || k || ((v = !0), $l(x))),
                C
            );
        }),
...
function ld(e, t, n, r, l, o, i, u, s) {
    (An = !1), (Yr = null), nd.apply(rd, arguments);
}
function od(e, t, n, r, l, o, i, u, s) {
    if ((ld.apply(this, arguments), An)) {
        if (An) {
            var a = Yr;
            (An = !1), (Yr = null);
...
function Sa(e) {
    return (e = id(e)), e !== null ? ka(e) : null;
}
function ka(e) {
...
var Ue = typeof Object.is == 'function' ? Object.is : np;
function Gn(e, t) {
    if (Ue(e, t)) return !0;
    if (
        typeof e != 'object' ||
...
for (var no = 0; no < Xu.length; no++) {
    var ro = Xu[no],
        op = ro.toLowerCase(),
        ip = ro[0].toUpperCase() + ro.slice(1);
    kt(op, 'on' + ip);
}
            ...
            e: {
                ...
                if (
                    ...
                    if (
                        ...
                        t: {
                            for (y = k, d = v, c = 0, p = y; p; p = Bt(p)) c++;
...
function oc(e) {
    ...
    function m(d, c, p, w) {
        ...
        if (typeof p == 'object' && p !== null) {
            ...
            if (Ln(p) || Sn(p)) return x !== null ? null : h(d, c, p, w, null);
            Tr(d, p);
        }
        return null;
    }
    function k(d, c, p, w, x) {
        ...
        if (typeof w == 'object' && w !== null) {
            switch (w.$$typeof) {
                ...
                case ot:
                    var N = w._init;
                    return k(d, c, p, N(w._payload), x);
            }
            if (Ln(w) || Sn(w))
                return (d = d.get(p) || null), h(c, d, w, x, null);
            Tr(c, w);
        }
        return null;
    }
    function v(d, c, p, w) {
        ...
        if (T === p.length) return n(d, P), B && Nt(d, T), x;
        if (P === null) {
            for (; T < p.length; T++)
                (P = f(d, p[T], w)),
                    P !== null &&
    ...
    function y(d, c, p, w) {
        ...
        for (
            var N = (x = null), P = c, T = (c = 0), Q = null, z = p.next();
            P !== null && !z.done;
            T++, z = p.next()
        ) {
            P.index > T ? ((Q = P), (P = null)) : (Q = P.sibling);
            var Le = m(d, P, z.value, w);
            if (Le === null) {
                P === null && (P = Q);
                break;
            }
        ...
        if (z.done) return n(d, P), B && Nt(d, T), x;
        if (P === null) {
        ...
        if (
            ...
            switch (p.$$typeof) {
                ...
                case $t:
                    ...
                    return i(d);
                case ot:
                    return (N = p._init), _(d, c, N(p._payload), w);
            }
            if (Ln(p)) return v(d, c, p, w);
            if (Sn(p)) return y(d, c, p, w);
            Tr(d, p);
        }
...
function qi(e, t, n, r, l, o) {
    if (
        ...
        (t.updateQueue = null),
        (t.lanes = 0),
        (Ir.current = e === null || e.memoizedState === null ? kp : Ep),
        (e = n(r, l)),
        In)
    ) {
        o = 0;
...
function Ec(e, t, n) {
    return At & 21
        ? (Ue(n, t) ||
              ((n = _a()), (H.lanes |= n), (jt |= n), (e.baseState = !0)),
          t)
        : (e.baseState && ((e.baseState = !1), (pe = !0)),
          (e.memoizedState = n));
}
function gp(e, t) {
    var n = j;
...
function Sp(e, t, n) {
    ...
    if (Cc(e)) _c(t, l);
        ...
        (n = tc(e, t, l, r)),
            n !== null && ((l = ae()), Me(n, e, r, l), Nc(n, t, r));
    }
}
function Cc(e) {
    var t = e.alternate;
...
function ys(e, t, n, r, l) {
    ...
    if ((rn(t, l), t.stateNode === null))
        ...
        u !== f || m !== v || he.current || it
            ? (typeof k == 'function' &&
                  (Zo(t, n, k, r), (v = t.memoizedState)),
              (a = it || is(t, n, a, r, m, v, s) || !1)
                  ? (h ||
...
function ye(e, t) {
    ...
    if (r === 0)
        ...
        if ((n != null && Fu(n), t === 1))
            e.tag === 0 ? mp(_s.bind(null, e)) : qa(_s.bind(null, e)),
                fp(function () {
                    !(D & 6) && xt();
                }),
                (n = null);
...
function yl(e, t) {
    ...
    while (1);
    if ((Vi(), (D = n), (pl.current = r), X !== null)) throw Error(S(261));
...
function Pt(e, t, n) {
    var r = j,
        l = Pe.transition;
    try {
        (Pe.transition = null), (j = 1), Mp(e, t, n, r);
    } finally {
        (Pe.transition = l), (j = r);
    }
    return null;
    ...
    if (e !== null)
        if (e.memoizedProps !== t.pendingProps || he.current) pe = !0;
            ...
            if (!(e.lanes & n) && !(t.flags & 128))
                return (pe = !1), Pp(e, t, n);
            pe = !!(e.flags & 131072);
        }
    else (pe = !1), B && t.flags & 1048576 && Za(t, il, t.index);
...
ya = ou;
va = Mt;
var Jp = { usingClientEntryPoint: !1, Events: [cr, Kt, Cl, ha, ma, ou] },
    Pn = {
    ...
    Xp = {
        ...
        findFiberByHostInstance: Pn.findFiberByHostInstance || Qp,
...
const Gp = ({ blog: e }) =>
        A.jsxs('div', { children: [e.title, ' ', e.author] }),
    qp = ({ createBlog: e }) => {
        ...
        return A.jsxs('form', {
            onSubmit: u,
            children: [
                A.jsx('h2', { children: 'Create New Blog' }),
                A.jsxs('div', {
                    children: [
                        'title: ',
                        A.jsx('input', {
                ...
                A.jsx('button', { type: 'submit', children: 'create' }),
            ],
        });
    },
    Os = ({ message: e, isError: t }) => {
        ...
        return A.jsx('div', { style: n, children: e });
    };
function tf(e, t) {
    return function () {
...
const fh = (e, t, n, { allOwnKeys: r } = {}) => (
    ...
    zs = '0123456789',
    af = { DIGIT: zs, ALPHA: vo, ALPHA_DIGIT: vo + vo.toUpperCase() + zs },
...
function Ul(e, t, n) {
    ...
    function h(v, y, _) {
        ...
        return mi(v) ? !0 : (t.append(Fs(_, y, o), a(v)), !1);
    }
    const f = [],
        m = Object.assign(Dh, {
            defaultVisitor: h,
            ...
            f.push(v),
                g.forEach(v, function (d, c) {
                    (!(g.isUndefined(d) || d === null) &&
                        l.call(t, d, g.isString(c) ? c.trim() : c, y, m)) ===
                        !0 && k(d, y ? y.concat(c) : [c]);
                }),
                f.pop();
        }
    }
...
const As = jh,
    ...
    Uh = typeof FormData < 'u' ? FormData : null,
    Ih = typeof Blob < 'u' ? Blob : null,
    Bh = {
        isBrowser: !0,
        classes: { URLSearchParams: Mh, FormData: Uh, Blob: Ih },
...
const mu = {
    ...
    transformRequest: [
        function (t, n) {
            ...
            return o || l
                ? (n.setContentType('application/json', !1), Jh(t))
                : t;
        },
    ],
    transformResponse: [
        ...
        function (e) {
            return new Promise(function (n, r) {
                ...
                f.open(
                    ...
                    hf(m, e.params, e.paramsSerializer),
                    !0
                ),
                    (f.timeout = e.timeout);
                function k() {
                ...
                if (
                    ...
                    const y =
                        e.xsrfHeaderName &&
                        e.xsrfCookieName &&
                        tm.read(e.xsrfCookieName);
                    y && o.set(e.xsrfHeaderName, y);
                }
                l === void 0 && o.setContentType(null),
                    'setRequestHeader' in f &&
                        g.forEach(o.toJSON(), function (_, d) {
...
const mm = (e) => {
    ...
    ym = () => Bl.get(wu).then((t) => t.data),
    vm = async (e) => {
        const t = { headers: { Authorization: xf } };
        return (await Bl.post(wu, e, t)).data;
    },
    gm = (e, t) => Bl.put(`${wu} /${e}`, t).then((r) => r.data),
    Rn = { getAll: ym, create: vm, update: gm, setToken: mm },
    wm = '/api/login',
    Sm = async (e) => (await Bl.post(wm, e)).data,
    km = { login: Sm },
    Em = () => {
        const [e, t] = xe.useState([]),
            ...
            [s, a] = xe.useState({ message: null, isError: !1 });
        xe.useEffect(() => {
            Rn.getAll().then((y) => t(y));
        }, []),
            xe.useEffect(() => {
                const y = window.localStorage.getItem('loggedBlogAppUser');
                if (y) {
                    const _ = JSON.parse(y);
                    u(_), Rn.setToken(_.token);
                }
            }, []);
        const h = (y, _ = !1) => {
                a({ message: y, isError: _ }),
                    setTimeout(() => {
            ...
            f = async (y) => {
                try {
                    const _ = await Rn.create(y);
                    t(e.concat(_)),
                        h(`A new blog ${_.title} by ${_.author} added`);
                } catch {
                    h('Failed to add blog', !0);
                }
            },
            m = async (y) => {
                y.preventDefault();
                try {
                    const _ = await km.login({ username: n, password: l });
                    window.localStorage.setItem(
                        ...
                        Rn.setToken(_.token),
                        u(_),
                        h('Logged in successfully'),
                        r(''),
                        o('');
                } catch {
                    h('Wrong username or password', !0),
                        setTimeout(() => {
            ...
            v = () =>
                A.jsxs('div', {
                    children: [
                        A.jsx('h2', { children: 'Log in to application' }),
                        A.jsx(Os, { message: s.message, isError: s.isError }),
                        A.jsxs('form', {
                            onSubmit: m,
                            children: [
                                A.jsxs('div', {
        ...
        return i === null
            ...
            : A.jsxs('div', {
                  children: [
                      ...
                      A.jsx(qp, { createBlog: f }),
                      A.jsx('br', {}),
                      e.map((y) => A.jsx(Gp, { blog: y }, y.id)),
                  ],
              });
    };
ko.createRoot(document.getElementById('root')).render(A.jsx(Em, {}));
