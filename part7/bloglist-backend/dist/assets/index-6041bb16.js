...
var rt = la.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function Di(e, t, n, r) {
    if (tl) {
        var l = Ho(e, t, n, r);
        if (l === null) uo(e, t, r, nl, n), Uu(e, r);
        else if (Nd(l, e, t, n, r)) r.stopPropagation();
        else if ((Uu(e, r), t & 4 && -1 < _d.indexOf(e))) {
            for (; l !== null; ) {
                var o = fr(l);
                if (
                    (o !== null && Oa(o),
    ...
    xl = V({}, cr, {
        ...
        movementX: function (e) {
            return 'movementX' in e
                ...
                : (e !== Nn &&
                      (Nn && e.type === 'mousemove'
                          ? ((Zl = e.screenX - Nn.screenX),
                            (bl = e.screenY - Nn.screenY))
                          : (bl = Zl = 0),
                      (Nn = e)),
                  Zl);
        },
...
var bd = be && 'TextEvent' in window && !Un,
    Ua = be && (!Mi || (Un && 8 < Un && 11 >= Un)),
...
function tp(e, t) {
    if (Qt)
        return e === 'compositionend' || (!Mi && Ia(e, t))
            ? ((e = Aa()), (Ir = Ai = ct = null), (Qt = !1), e)
            : null;
    switch (e) {
        case 'paste':
            return null;
...
function Ju() {
    In && (In.detachEvent('onpropertychange', Ha), (Gn = In = null));
}
function Ha(e) {
...
function op(e, t, n) {
    e === 'focusin'
        ? (Ju(), (In = t), (Gn = n), In.attachEvent('onpropertychange', Ha))
        : e === 'focusout' && Ju();
}
function ip(e) {
...
var fp = be && 'documentMode' in document && 11 >= document.documentMode,
    Kt = null,
    Vo = null,
    Mn = null,
    Wo = !1;
...
function Ct() {
    if (!ao && Xe !== null) {
        ...
        try {
            ...
            throw (Xe !== null && (Xe = Xe.slice(e + 1)), _a(zi, Ct), l);
        } finally {
            (A = t), (ao = !1);
        }
    }
...
function tc(e, t, n) {
    (Ce[_e++] = Ye), (Ce[_e++] = Ge), (Ce[_e++] = At), (At = e);
    var r = Ye;
    e = Ge;
    var l = 32 - Ae(r) - 1;
    (r &= ~(1 << l)), (n += 1);
...
var xp = rt.ReactCurrentBatchConfig;
function je(e, t) {
    if (e && e.defaultProps) {
...
function sc(e) {
            ...
            : a !== null &&
                (a.elementType === E ||
                    (typeof E == 'object' &&
                        ...
                        E.$$typeof === it &&
                        fs(E) === a.type))
              ? ((w = l(a, d.props)), (w.ref = Pn(p, a, d)), (w.return = p), w)
    ...
    function y(p, a, d, w) {
        ...
        if (P === d.length) return n(p, N), B && Tt(p, P), E;
        if (N === null) {
            for (; P < d.length; P++)
                (N = f(p, d[P], w)),
                    N !== null &&
    ...
    function v(p, a, d, w) {
        ...
        if (j.done) return n(p, N), B && Tt(p, P), E;
        if (N === null) {
        ...
        if (
            ...
            switch (d.$$typeof) {
                ...
                case Vt:
                    ...
                    return i(p);
                case it:
                    return (C = d._init), R(p, a, C(d._payload), w);
            }
...
function Yi(e, t) {
    switch ((U(nr, t), U(tr, e), U(Qe, dr), (e = t.nodeType), e)) {
        case 9:
        case 11:
...
function _c(e, t, n) {
    return Ut & 21
        ? (Ie(n, t) ||
              ((n = Ta()), (H.lanes |= n), (It |= n), (e.baseState = !0)),
          t)
...
function Pp(e, t, n) {
    ...
    if (Pc(e)) Tc(t, l);
        ...
        (n = lc(e, t, l, r)),
            n !== null && ((l = ce()), Ue(n, e, r, l), Rc(n, t, r));
    }
}
function Pc(e) {
    var t = e.alternate;
...
function li(e, t, n, r, l, o) {
    Fc(e, t);
    var i = (t.flags & 128) !== 0;
    if (!r && !i) return l && ls(t, n, !1), nt(e, t, o);
...
function Fp(e, t, n) {
    switch (t.tag) {
        ...
        case 10:
            ...
            U(al, r._currentValue), (r._currentValue = l);
            break;
        case 13:
    ...
    switch ((Hi(t), t.tag)) {
        ...
        case 5:
            ...
            if (((n = t.type), e !== null && t.stateNode != null))
                ...
                if (((e = zt(Qe.current)), Rr(t))) {
                    (r = t.stateNode), (n = t.type);
                    var o = t.memoizedProps;
                    switch (
                        ((r[He] = t), (r[er] = o), (e = (t.mode & 1) !== 0), n)
                    ) {
                        case 'dialog':
        ...
        case 6:
            if (e && t.stateNode != null) Bc(e, t, e.memoizedProps, r);
                ...
                if (typeof r != 'string' && t.stateNode === null)
                    throw Error(S(166));
                if (((n = zt(nr.current)), zt(Qe.current), Rr(t))) {
                    if (
                        ((r = t.stateNode),
                        (n = t.memoizedProps),
                        (r[He] = t),
...
function Kc(e, t) {
    ...
    if (r & 30 || r & e.expiredLanes || t) t = gl(e, r);
        ...
        D |= 2;
        var o = Xc();
        (ee !== e || re !== t) && ((Je = null), (hn = J() + 500), jt(e, t));
        do
            try {
                Vp();
                break;
            ...
            switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
                ...
                case 3:
                    if (
                        ...
                        e.timeoutHandle = Xo(Rt.bind(null, e, pe, Je), t);
                        break;
                    }
                    Rt(e, pe, Je);
                    break;
                case 4:
                    ...
                    if (
                        ...
                        e.timeoutHandle = Xo(Rt.bind(null, e, pe, Je), r);
                        break;
                    }
                    Rt(e, pe, Je);
                    break;
...
function au() {
    (q === 0 || q === 3 || q === 2) && (q = 4),
        ee === null || (!(It & 268435455) && !(Ll & 268435455)) || at(ee, re);
}
function gl(e, t) {
    var n = D;
    D |= 2;
    var r = Xc();
    (ee !== e || re !== t) && ((Je = null), jt(e, t));
    do
        try {
            Hp();
            break;
...
wa = uu;
Sa = Mt;
var eh = { usingClientEntryPoint: !1, Events: [fr, Xt, Nl, va, ga, uu] },
    Rn = {
...
var uh = lf.exports;
const Be = Lf(uh),
    sf = ({ blog: e, onLike: t, onRemove: n, currentUser: r }) => {
...
sf.propTypes = {
    blog: Be.shape({
        ...
        author: Be.string.isRequired,
        url: Be.string.isRequired,
        likes: Be.number.isRequired,
    }).isRequired,
    onLike: Be.func.isRequired,
    onRemove: Be.func.isRequired,
    currentUser: Be.object,
};
const sh = ({ createBlog: e }) => {
        ...
        return T.jsxs('form', {
            ...
            children: [
                ...
                T.jsxs('div', {
                    children: [
                        T.jsx('label', { htmlFor: 'url', children: 'URL:' }),
                        '  ',
                        T.jsx('input', {
                            id: 'url',
                            value: o,
...
mu.propTypes = { buttonLabel: Be.string.isRequired };
function af(e, t) {
    return function () {
...
function Bl(e, t, n) {
    ...
    function h(y, v, R) {
        ...
        return vi(y) ? !0 : (t.append(As(R, v, o), c(y)), !1);
    }
    const f = [],
        m = Object.assign(Qh, {
            defaultVisitor: h,
...
const dm = Ve.hasStandardBrowserEnv
    ? {
          write(e, t, n, r, l, o) {
...
const mm = Ve.hasStandardBrowserEnv
    ? (function () {
            ...
            return new Promise(function (n, r) {
                ...
                l === void 0 && o.setContentType(null),
                    'setRequestHeader' in f &&
                        g.forEach(o.toJSON(), function (R, p) {
                            f.setRequestHeader(p, R);
                        }),
...
function Hs(e) {
    return (
        ...
        Pf.getAdapter(e.adapter || wu.adapter)(e).then(
            function (r) {
                return (
                    Eo(e),
...
const Nm = (e) => {
    ...
    Pt = { getAll: Pm, create: Tm, update: Rm, remove: Om, setToken: Nm },
    Lm = '/api/login',
            ...
            p = () =>
                T.jsxs('div', {
                    children: [
                        ...
                        T.jsx(js, { message: s.message, isError: s.isError }),
                        T.jsxs('form', {
                            onSubmit: k,
                            children: [
                                T.jsxs('div', {
            ...
            : T.jsxs('div', {
                  children: [
                      ...
                      T.jsx(mu, {
                          ...
                          ref: h,
                          children: T.jsx(sh, { createBlog: m }),
                      }),
                      T.jsx('br', {}),
                      e.map((a) =>
                          T.jsx(
...
xo.createRoot(document.getElementById('root')).render(T.jsx(Fm, {}));
