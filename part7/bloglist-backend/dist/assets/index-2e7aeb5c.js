...
var bd = Ze && 'TextEvent' in window && !Un,
    Ua = Ze && (!Mi || (Un && 8 < Un && 11 >= Un)),
...
function Yi(e, t) {
    switch ((U(nr, t), U(tr, e), U(We, dr), (e = t.nodeType), e)) {
        case 9:
        case 11:
...
const sh = ({ createBlog: e }) => {
    ...
    js = ({ message: e, isError: t }) => {
        ...
        return T.jsx('div', { style: n, children: e });
    },
